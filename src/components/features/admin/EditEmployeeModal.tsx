...
export default function EditEmployeeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40">
      <div
        className="w-full max-w-md rounded-t-3xl bg-background p-5 pb-8 animate-in slide-in-from-bottom duration-250 max-h-[92dvh] overflow-y-auto"
      ...
      >
        ...
        {/* ── Tab: Thông tin ──────────────────────── */}
        {tab === "info" && (
          <div key="info" className="space-y-3 animate-in fade-in duration-200">
            {/* Họ tên + Vai trò */}
